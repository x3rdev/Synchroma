...
public class AdvancedSolarPanelScreen extends SynchromaScreen<AdvancedSolarPanelMenu>{
    private static final ResourceLocation CONTAINER_LOCATION = new ResourceLocation(Synchroma.MOD_ID, "textures/gui/container/advanced_solar_panel.png");

    public AdvancedSolarPanelScreen(AdvancedSolarPanelMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
