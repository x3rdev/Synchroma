...
public class AdvancedSolarPanelModel extends DefaultedBlockGeoModel<AdvancedSolarPanelBlockEntity> {

    public AdvancedSolarPanelModel() {
        super(new ResourceLocation(Synchroma.MOD_ID, "advanced_solar_panel"));
    }
