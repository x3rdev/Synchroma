...
public class ZenithSolarPanelScreen extends SynchromaScreen<ZenithSolarPanelMenu>{
    private static final ResourceLocation CONTAINER_LOCATION = new ResourceLocation(Synchroma.MOD_ID, "textures/gui/container/zenith_solar_panel.png");

    public ZenithSolarPanelScreen(ZenithSolarPanelMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
