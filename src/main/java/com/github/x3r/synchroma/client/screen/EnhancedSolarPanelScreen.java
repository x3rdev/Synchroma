...
public class EnhancedSolarPanelScreen extends SynchromaScreen<EnhancedSolarPanelMenu>{
    private static final ResourceLocation CONTAINER_LOCATION = new ResourceLocation(Synchroma.MOD_ID, "textures/gui/container/enhanced_solar_panel.png");

    public EnhancedSolarPanelScreen(EnhancedSolarPanelMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
